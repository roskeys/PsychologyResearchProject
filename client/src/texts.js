...
export const experiment1_intro_1 = <div style={style}>
    ...
    <li>After viewing the 25 smiling faces, please submit your estimation of the <b>probability for smiling faces
        showing up on the left</b> using the scrollbar and press the <b>“Submit”</b> button.
    </li>
</div>
...
export const experiment2_intro_1 = <div style={style}>
...
export const experiment2_intro_2 = <div style={style}>
    <li>In this experiment, you will see 25 images of dice numbers in sequence.</li>
...
export const experiment3_intro = <div style={style}>
    <li>In this experiment, you will see 25 images of smiling faces in sequence.</li>
    <li>After viewing each smiling face, press the “Next” button to proceed to the next round.</li>
    <li><b>Please move on to the next image as fast as possible.</b></li>
    <li>After viewing the 25 smiling faces, please submit your estimation of the <b>probability for smiling faces
        showing up on the left</b> using the scrollbar and press the “Submit” button.
    </li>
</div>;
